...
else if(Rxdata=="*Bedroom Light Off#"){
...
else if(Rxdata=="*All Appliances On#"){
digitalWrite(relay_1,HIGH);
...
Myserial.print("Study Room Lights ON");
...
Myserial.print("Study Room Lights OFF");
